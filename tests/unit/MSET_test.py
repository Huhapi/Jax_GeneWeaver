...
if __name__ == "__main__":
    ...
    file_path_1 = os.path.abspath("../Jax_GeneWeaver/src/tests/unit/RATUS1")
    file_path_2 = os.path.abspath("../Jax_GeneWeaver/src/tests/unit/ratus2")
    background_file_path = os.path.abspath("../Jax_GeneWeaver/src/tests/unit/KEGGRattusnorvegicusBG.txt")
